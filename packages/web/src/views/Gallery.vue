                    ...
                    <template v-if="!isSelectionMode">
                      ...
                      <sl-dropdown>
                        ...
                        <sl-menu @sl-select="onOptionsSelect">
                          ...
                          <sl-menu-item v-if="hasPhotosWithUnknownDates" value="viewUnknownDateItems" type="checkbox" :checked="showUnknownDateItems">
              ...
              <div>
                ...
                <span v-if="photos.filter(p => !p.date).length">&nbsp;&bull; {{ photos.filter(p => !p.date).length }} unknown dates
                  <span class="text-xs md:text-sm text-gray-500">
                    <button v-if="showUnknownDateItems" @click="showUnknownDateItems = false">
                    ...
                    <button v-else @click="showUnknownDateItems = true">
                ...
                <span v-if="date">&nbsp;&bull; before {{ date }}
                  <button @click="clearDate()">
                    <svg class="inline w-4 h-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                  </button>
                </span>
              </div>
            </div>
...
export default {
  ...
  computed: {
    ...
    displayedPhotos() {
      ...
      return this.photos
      .filter(photo => this.showUnknownDateItems || photo.date)
      .sort((a, b) => {
  ...
  methods: {
    ...
    onOptionsSelect(e) {
      ...
      if (item.value === 'viewUnknownDateItems') {
        this.showUnknownDateItems = item.checked;
      }
